                    ...
                    <div class="col-12">
                        <form method="POST" action="{{ route('user-profile-information.update') }}" class="card bg-white border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <h5 class="card-title fw-bold color-green">Account informatie</h5>
                                        <h6 class="card-subtitle text-muted border-bottom pb-2">Update de profielgegevens en het e-mailadres van uw account.</h6>
                                    </div>
