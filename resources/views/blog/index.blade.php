...
@section('content')
    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="card bg-sidenav border-0 shadow-sm text-center">
                        <div class="card-body p-4">
                            ...
                            <p class="card-text text-muted mb-3">
                                Momenteel zijn er geen artikelen in het Vlaams Woordenboek te vinden die voldoen aan je
                                zoekopdracht of categorie. Probeer een andere zoekterm of kom later nog eens terug.
                            </p>
            ...
            <div class="col-lg-4">
                <!-- Search widget-->
                <h5 class="border-bottom pb-2 border-green color-green fw-bold"><x-heroicon-o-magnifying-glass-circle
                        class="icon me-1" /> Artikel opzoeken</h5>
                ...
                <form action="{{ route('news:index') }}" method="GET" class="mb-4 border-0 shadow-sm">
                    <div class="input-group">
                        <input class="form-control" type="text" name="zoekterm"
                            placeholder="Zoek op de titel van het artikel..."
                            aria-label="Zoek op de titel van het artikel..." value="{{ request()->get('zoekterm') }}"
                ...
                <!-- Categories widget-->
                <h5 class="border-bottom pb-2 border-green color-green fw-bold"><x-heroicon-s-tag class="icon me-1" />
                    Categorieen</h5>

                <div class="border-bottom pb-2 border-green">
                    @foreach ($categories as $category)
                        <a href="{{ route('categories:show', $category) }}"
                            class="badge badge-primary shadow-sm text-decoration-none">
                            {{ $category->name }} <span
                ...
                <div class="row">
                    <div class="@if (optional(auth()->user())->can('create', \App\Models\Blog::class)) col-6 @else col-12 @endif">
                    ...
                    @can('create', \App\Models\Blog::class)
                        <div class="col-6">
                            <a href="{{ route('news:create') }}" class="btn mt-2 w-100 btn-light border-0 shadow-sm">
