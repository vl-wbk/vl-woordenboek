                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex gap-2 text-uppercase fw-bold" style="font-size: .80rem;">
                        <span class="badge rounded-pill border text-primary bg-primary bg-opacity-10 px-3 py-1">
                            <x-heroicon-o-user-group class="icon-sm me-1"/>{{ auth()->user()->user_type->getLabel() }}
                        </span>
    ...
    <div class="row justify-content-center g-5">
        ...
        <div class="col-lg-2">
            ...
            <div class="mb-4">
                ...
                <nav class="nav flex-column">
                    <a href="{{ route('suggestions:index') }}" class="sidenav-link {{ active('suggestions:index') }}">
                        <x-heroicon-o-document-text class="icon color-green"/>
                        <span class="flex-grow-1">Openstaande</span>
                    </a>
                    <a href="{{ route('suggestions:processing') }}" class="sidenav-link {{ active('suggestions:processing') }}">
                        <x-heroicon-o-pencil-square class="icon color-green"/>
                        <span class="flex-grow-1">In behandeling</span>
                    </a>
                    <a href="{{ route('suggestions:archived') }}" class="sidenav-link {{ active('suggestions:archived') }}">
