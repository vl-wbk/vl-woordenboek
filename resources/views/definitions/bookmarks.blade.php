    ...
    @if ($bookmarks->total() > 0)
        ...
        <div class="d-flex align-items-center justify-content-between mt-3">
            <div class="text-muted small">
                Toont <span class="fw-semibold text-dark">{{ $bookmarks->firstItem() }}-{{ $bookmarks->lastItem() }}</span> van <span class="fw-semibold text-dark">{{ $bookmarks->total() }}</span> bewaarde woorden
            </div>
            ...
            <div class="d-flex flex-column align-items-center justify-content-center text-center p-5">
                ...
                <div class="mb-4 position-relative">
                    <div class="rounded-circle bg-white shadow-sm d-flex align-items-center justify-content-center" style="width: 80px; height: 80px; border: 1px solid var(--border);">
                        <x-heroicon-o-bookmark-slash class="text-muted-foreground" style="width: 32px;"/>
                    </div>
                </div>

                <h4 class="fw-bold mb-2">Geen bewaarde woorden gevonden</h4>
