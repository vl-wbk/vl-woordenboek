        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3 border-bottom border-green pb-2">
            <div>
                <h1 class="display-5 d-flex align-items-center justify-content-between">
                    <span>Regio: <span class="color-green">{{ $region->name }}</span></span>
                </h1>
                <div class="pb-3">
                ...
                <p class="text-muted pb-2">{{ $region->description }}</p>
                <small class="text-secondary">Aangemaakt op {{ $region->created_at->locale('nl_BE')->isoFormat('DD MMMM YYYY') }} | Laatst bijgewerkt op {{ $region->updated_at->locale('nl_BE')->isoFormat('DD MMMM YYYY') }}</small>
            </div>
        </div>
        ...
        <section class="mb-5">
            ...
            <ul class="list-group border-0 shadow-sm">
                <li class="list-group-item">
                    <strong>Aangemaakt op:</strong> <span class="float-end">{{ $region->created_at->locale('nl_BE')->isoFormat('DD MMMM YYYY') }}</span>
                </li>
                <li class="list-group-item">
                    <strong>Laatste bewerking:</strong> <span class="float-end">{{ $region->updated_at->locale('nl_BE')->isoFormat('DD MMMM YYYY') }}</span>
                </li>
            </ul>
        </section>
