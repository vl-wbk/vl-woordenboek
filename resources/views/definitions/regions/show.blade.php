    ...
    <div class="bg-light bg-blend-hard-light rounded-3 shadow-sm">
        <div class="px-5 py-5">
            <div class="container-fluid">
                <h1 class="display-5">Regio: <span class="text-warning">{{ $region->name }}</span></h1>
                ...
                <p class="fs-5 pt-3">
                    Aangemaakt op {{ $region->created_at->locale('nl_BE')->isoFormat('DD MMMM YYYY') }} | Laatst bijgewerkt op {{ $region->updated_at->locale('nl_BE')->isoFormat('DD MMMM YYYY') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="py-5">
        <div class="container-fluid">
            <div class="row">
                <div class="col-3">
                    <section class="mb-5">
                        <h2 class="mb-4 text-gold">Deze regio in cijfers</h2>
                        ...
                        <ul class="list-group border-0 shadow-sm">
                            ...
                            <li class="list-group-item">
                                ...
                                <span class="float-end text-muted">
                                {{ $analytics['contributor']['statistic'] }}
                            </span>
                            </li>
                            ...
                            <li class="list-group-item">
                                ...
                                <span class="float-end">{{ $analytics['report']['statistic'] }}</span>
                            </li>
                        </ul>
                        ...
                        <ul class="list-group border-0 shadow-sm">
                            <li class="list-group-item">
                                <x-heroicon-s-calendar class="icon color-green me-2"/>
                                <strong>Aangemaakt op:</strong>
                                <span class="float-end">{{ $region->created_at->locale('nl_BE')->isoFormat('DD MMMM YYYY') }}</span>
                            </li>

                            <li class="list-group-item">
                                <x-heroicon-s-clock class="icon color-green me-2"/>

                                <strong>Laatste bewerking:</strong>
                                <span class="float-end">{{ $region->updated_at->locale('nl_BE')->diffForHumans() }}</span>
                            </li>
                        </ul>
                    </section>
                </div>
