...
@section('jumbotron')
    <div class="bg-light bg-blend-hard-light rounded-3 shadow-sm">
        <div class="container-fluid">
            <div class="px-5 py-5">
                <div class="row">
                    <h1 class="display-6 fw-bold">Gebruikersvoorwaarden van het <span class="text-warning">Vlaams Woordenboek</span></h1>
                ...
                <div class="col-12 py-3">
                    <div class="card bg-white border-0 shadow-sm">
                        <div class="card-body disclaimer-description">
                            ...
                            <h3 class="color-green">De site en het gebruik</h3>
                            ...
                            <p>
                                Gebruikers die inbreuken op de Gebruiksvoorwaarden of op hun eigen auteursrecht vaststellen, kunnen hierover contact opnemen met de beheerder of de kerngroep.
                            </p>
                            ...
                            <p>
                                Voor vlaamswoordenboek.be verzamelt, bewaart en gebruikt het beheer daarnaast pesoonsgegevens (mailadres en IP-adres) van gebruikers die zich registeren, met als doel:
                            </p>

                            <ul>
                                <li>verificatie van het e-mailadres en authenticatie van gebruikers die zich registreren</li>
                                <li>identificatie van geregistreerde gebruikers, bijvoorbeeld voor wachtwoordherstel</li>
                            </ul>

                            <p>
                                Het beheer gebruikt je persoonsgegevens niet voor marketingdoeleinden en verstrekt ze niet aan derde landen of partijen.
                                Als er gegevens uit vlaamswoordenboek.be aan taalwetenschappers worden bezorgd voor wetenschappelijk onderzoek, zullen die volledig anoniem zijn. Zij krijgen geen gegevens van gebruikers.
                                Voor administratieve doeleinden kunnen andere partijen toegang tot je mailadres krijgen, waaronder het hostingbedrijf van de website en e-maildiensten.
                                Al deze partijen voldoen aan de AVG.
                            </p>

                            <p>
                                De mailadressen zijn nodig voor het beheer van geregistreerde gebruikers.
                                Ze worden bijgehouden en uitsluitend voor dit doel gebruikt totdat je je uitdrukkelijk uitschrijft.
                            </p>

                            <p>
                                Om je persoonsgegevens te beveiligen, heeft het beheer passende technische en organisatorische maatregelen genomen.
                                De keuze van deze maatregelen is gebaseerd op de beschikbare technologie, de uitvoeringskosten, het type persoonsgegevens die verwerkt worden en de risico’s die daaraan verbonden zijn.
                                Wij streven ernaar dat deze maatregelen voldoen aan de eisen in artikel 32 van de AVG. Bij een datalek zal ik uiterlijk binnen de 72 uur de gepaste acties ondernemen zoals dit in de verordening is bepaald.
                            </p>

                            <p>
                                Je hebt het recht om de persoonsgegevens die in ons bezit zijn in te zien, te wijzigen of te verwijderen.
                                Als je je verzoek per e-mail indient, zal het beheer er zo snel mogelijk gevolg aan geven, uiterlijk een maand na de dag waarop je je verzoek hebt verstuurd.
                            </p>

                            <p>
                                Als je twijfels of vragen hebt over de manier waarop uw persoonsgegevens verwerkt worden, neem dan contact op.
                                Je hebt ook het recht om een klacht in te dienen bij de toezichthoudende instantie in België.
                            </p>
                            ...
                            <p>
                                Het is de gebruiker niet toegestaan om commerciële activiteiten op te zetten die verband houden met vlaamswoordenboek.be zonder de uitdrukkelijke schriftelijke toestemming van het beheer.
                            </p>

                            <h3 class="color-green">Advertenties</h3>

                            <p>
                                Het beheer heeft het recht om advertenties en promoties op te nemen op de website om de kosten te dekken. De manier waarop dit gebeurt kan in de toekomst veranderen.
                            </p>
