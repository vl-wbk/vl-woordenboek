...
final class FeedbackSubmissionData extends Data
{
    public function __construct(
        ...
        #[MapInputName('eerste_bezoek')]                public readonly FeedbackTrueFalse $first_time_visit,
        #[MapInputName('resultaten_gevonden')]          public readonly FeedbackTrueFalse $results_found_easily,
        #[MapInputName('email')]                        public readonly ?string $email = null,
        #[MapInputName('bezoek_redenen')]               public readonly ?string $visit_reason = null,
