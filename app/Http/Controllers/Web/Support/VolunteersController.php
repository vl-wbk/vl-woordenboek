...
final readonly class VolunteersController
{
    ...
    #[Get(uri: 'vijwilligers/aanmelden/{volunteerPosition}', name: 'volunteers.apply', middleware: ['auth'])]
    public function applicationForm(Request $request, VolunteerPosition $volunteerPosition): Renderable
    {
        ...
        return view('volunteers.apply', data: [
            'user' => $request->user(),
            'regions' => Region::all(),
    ...
    #[Post(uri: 'vijwilligers/aanmelden/{volunteerPosition}', name: 'volunteers.apply.store', middleware: ['auth'])]
