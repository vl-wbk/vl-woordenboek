...
/**
 * Provides a lookup for Passkey Authenticator AAGUIDs.
 *
 * @see https://github.com/passkeydeveloper/passkey-authenticator-aaguids/blob/main/aaguid.json
 */
final class PasskeyAuthenticatorAaguids
{
    /**
     * Map of AAGUID to Authenticator Name.
     *
    ...
    private const MAP = [
        ...
        "8836336a-f590-0921-301d-46427531eee6" => "Thales Bio Andriod SDK",
        "cd69adb5-3c7a-deb9-3177-6800ea6cb72a" => "Thales PIN Andriod SDK",
        ...
        "c9cadfc9-89a9-489e-a25a-c7e86a4d5f15" => "Burp Suite",
    ];

    /**
     * Finds authenticator details by AAGUID string.
     *
     * @param string $aaguid
     * @return array{name: string, aaguid: string}|null
     */
    public static function findByAaguid(string $aaguid): ?array
    {
        $name = self::MAP[strtolower($aaguid)] ?? null;
