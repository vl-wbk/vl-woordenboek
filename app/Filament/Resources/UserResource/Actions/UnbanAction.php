...
final class UnbanAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $this->label(label: __('user-resource.actions.reactivate-user.label'));
        $this->color('warning');
        $this->icon('tabler-lock-open-2');
        $this->modalHeading(heading: __('user-resource.actions.reactivate-user.modal.heading'));
        $this->modalSubmitActionLabel(label: __('user-resource.actions.reactivate-user.buttons.confirm'));
        ...
        $this->action(function (): void {
            ...
            $this->successNotificationTitle(title: __('notifications.actions.reactivate-user.success-title'));
            $this->success();
        });
    }
}
