...
/**
 * EditUser provides the user editing interface in the Vlaams Woordenboek administrator panel.
 *
 * This page component handles the modification of existing user records through a form-based interface.
 * It extends Filament's EditRecord to provide a standardized editing experience while maintaining the app's design patterns and Dutch-language interface elements.
 *
