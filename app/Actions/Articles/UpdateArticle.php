 ...
 *
 * 1. Updates the provided `Article` model (which represents an article) with the data from the `ArticleObjectData` DTO.
 * 2. If the update is successful, sets the current authenticated user as the editor of the article.  This is done using the `setEditor()` method on the `Article` model.
 *
